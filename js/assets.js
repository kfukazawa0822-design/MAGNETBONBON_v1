...
const IMAGE_ASSET_PATHS = {
  ...
  player: {
    ...
    skin1_s:   'assets/player/player_skin1_s.webp',   // ショップ「プレイヤー機体スキン①」(player_skin_1)
    skin1_n:   'assets/player/player_skin1_n.webp',
    skin2_s:   'assets/player/player_skin2_s.webp',   // ショップ「プレイヤー機体スキン②」(player_skin_2)
    skin2_n:   'assets/player/player_skin2_n.webp',
    special_s: 'assets/player/player_special_s.webp', // 有料応援パック②の限定スキン
    special_n: 'assets/player/player_special_n.webp',
  },
  collection: {
    profile:      'assets/collection/profile.svg',
    tutorial:     'assets/collection/tutorial.svg',
    zukan:        'assets/collection/zukan.svg',
    achievements: 'assets/collection/achievements.svg',
  },
